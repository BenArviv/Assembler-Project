assembler: main2.o preAssembler.o utils.o firstPass2.o labelUtils.o
	gcc -g -ansi -Wall -pedantic main2.o preAssembler.o utils.o firstPass2.o labelUtils.o -o assembler -lm
