...
/* Directives types */
enum directives {DATA, STRING, STRUCT, ENTRY, EXTERN, UNKNOWN_DIR}; 
...
enum errors {
    ...
    STRING_TOO_MANY_OPERANDS, STRING_OPERAND_NOT_VALID, STRUCT_EXPECTED_STRING, STRUCT_COMMA_IN_A_ROW, STRUCT_EXTRA_CHARS,
    STRUCT_INVALID_STRING, EXPECTED_COMMA_BETWEEN_OPERANDS, STRUCT_MISSING_STR, STRUCT_NO_OPERANDS, STRUCT_INVALID_NUM, STRUCT_TOO_MANY_OPERANDS,
